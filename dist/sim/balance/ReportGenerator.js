...
export class ReportGenerator {
     ...
     */
    generateReport(analyses, compliance, outliers, duration, config) {
        const report = {
            metadata: {
     ...
     */
    generateSummary(analyses, compliance) {
    ...
    generateComplianceSection(compliance) {
        ...
        for (const result of compliance) {
            ...
            switch (result.overall) {
                case 'compliant':
                    playbookData.compliant++;
                    break;
                case 'warning':
                    playbookData.warning++;
                    break;
                case 'violation':
                    playbookData.violation++;
                    break;
                case 'critical':
                    playbookData.critical++;
                    break;
            }
        }
     ...
     */
    generateRecommendationsSection(compliance, outliers) {
        const priority = [];
        const byPlaybook = {};
     ...
     */
    generateDetailedResults(analyses, compliance, outliers) {
        const results = [];
