 ...
 */
export function registerEngineIndicator(bus) {
    ...
    bus.on('ui:engineChanged', ({ engine }) => {
 ...
 */
export function updateEngineIndicatorVisibility(devModeEnabled) {
    if (typeof document === 'undefined')
        return;
 ...
 */
export function removeEngineIndicator() {
    if (typeof document === 'undefined')
        return;
    const indicator = document.getElementById('engine-indicator');
    if (indicator) {
...
//# sourceMappingURL=EngineIndicator.js.map