...
function getVisualProperties(cardName, cardType, playbook) {
    ...
    let riskLevel = 3; // Default medium risk
...
const DEFENSIVE_CARDS = [
    { label: 'Goal Line', visual: { riskLevel: 2, perimeterBias: 0.5, theme: 'defense' } },
    { label: 'All-Out Blitz', visual: { riskLevel: 5, perimeterBias: 0.5, theme: 'defense' } },
    { label: 'Inside Blitz', visual: { riskLevel: 4, perimeterBias: 0.3, theme: 'defense' } },
    { label: 'Outside Blitz', visual: { riskLevel: 4, perimeterBias: 0.8, theme: 'defense' } },
    { label: 'Cover 1', visual: { riskLevel: 3, perimeterBias: 0.6, theme: 'defense' } },
    { label: 'Cover 2', visual: { riskLevel: 3, perimeterBias: 0.5, theme: 'defense' } },
    { label: 'Cover 3', visual: { riskLevel: 3, perimeterBias: 0.7, theme: 'defense' } },
    { label: 'Cover 4', visual: { riskLevel: 3, perimeterBias: 0.5, theme: 'defense' } },
    { label: 'Cover 6', visual: { riskLevel: 3, perimeterBias: 0.6, theme: 'defense' } },
    { label: 'Prevent', visual: { riskLevel: 2, perimeterBias: 0.4, theme: 'defense' } }
];
/**
...
export class CardDefinitions {
     ...
     */
    getOffensiveCards(playbook) {
        return Array.from(this.cards.values())
            .filter((card) => 'playbook' in card && card.playbook === playbook);
    }
    /**
    ...
    getCardsByType(type) {
        return Array.from(this.cards.values())
            .filter((card) => 'type' in card && card.type === type);
    }
    /**
     * Gets cards by risk level range
     */
    getCardsByRiskLevel(minLevel, maxLevel) {
        return Array.from(this.cards.values())
