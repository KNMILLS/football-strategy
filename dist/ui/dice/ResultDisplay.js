...
export class ResultDisplay {
    ...
    showResult(diceResult, outcome) {
        ...
        if (this.config.accessibility.announceResults) {
            this.announceToScreenReader(`Dice roll: ${diceResult.d1} and ${diceResult.d2}, total ${diceResult.sum}. ${outcome.tags.join(', ')}.`);
        }
    }
    showDiceAnimation(diceResult, outcome) {
