 ...
 */
export function scaffoldMatchupTable(options) {
    const warnings = [];
    const suggestions = [];
    // Validate inputs
    ...
    const table = {
        ...
        dice: '2d20',
        entries: {}, // Will be populated in the loop below
        doubles: {
            '1': { result: 'DEF_TD' },
            '20': { result: 'OFF_TD' },
 ...
 */
function createEntryForSum(sum, defaults, template) {
 ...
 */
function selectClockByWeight(distribution) {
 ...
 */
export function suggestTableName(offCard, defCard) {
...
//# sourceMappingURL=TableScaffolder.js.map