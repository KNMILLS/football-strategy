 ...
 */
export function validateTableWithFeedback(table) {
    const errors = [];
    const warnings = [];
    const suggestions = [];
    let score = 100;
 ...
 */
function validateGddRequirements(table) {
    const errors = [];
    const warnings = [];
    // Check turnover band (3-5)
    const turnoverBandSums = ['3', '4', '5'];
    const missingTurnoverBand = turnoverBandSums.filter(sum => !table.entries[sum]);
 ...
 */
function analyzeBalanceCharacteristics(table) {
    const warnings = [];
    const suggestions = [];
 ...
 */
function validateStructuralConsistency(table) {
    const warnings = [];
    const suggestions = [];
    ...
    const missingSums = expectedSums.filter(sum => !table.entries[sum]);
 ...
 */
function suggestPlaybookIdentity(table) {
    const suggestions = [];
    const outcomes = Object.values(table.entries);
 ...
 */
export function validateEntry(entry, sum) {
    const errors = [];
    const warnings = [];
    const suggestions = [];
    // Validate yards
...
//# sourceMappingURL=ValidationFeedback.js.map