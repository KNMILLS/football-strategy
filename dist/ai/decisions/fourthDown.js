...
export function decideFourthDown(ai) {
    ...
    try {
        ...
        if (special === 'field_goal' && attemptYards <= 45)
    ...
    const shouldPunt = (() => {
        ...
        if (deepOwn && toGo >= 2) {
            ...
            if (!urgentLateAndShort)
                return true;
        }
        // General own side guidance
        if (toGo >= 5)
            return true;
        if (yardsToOpp > 50 && toGo >= 3)
            return true;
...
//# sourceMappingURL=fourthDown.js.map