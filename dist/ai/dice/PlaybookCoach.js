...
export class PlaybookCoach {
     ...
     */
    selectOffensivePlay(gameState, availableCards, defensivePlays, matchupTables, // Simplified for this implementation
    penaltyTable, rngSeed) {
     ...
     */
    calculateCandidateEV(card, defensePlay, context, rngSeed) {
