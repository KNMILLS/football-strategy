 ...
 */
export function scoreAnchorLine(s) {
 ...
 */
export function formatPossessionSpotForBroadcast(possessing, ballOn) {
 ...
 */
export function formatTeamYardLine(possessing, ballOn) {
...
//# sourceMappingURL=GameFlowFormatting.js.map