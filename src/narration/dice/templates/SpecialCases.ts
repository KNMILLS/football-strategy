...
export const SPECIAL_CASE_ANALYST_TEMPLATES: CommentaryTemplate[] = [
  {
    tags: ['safety'],
    priority: 25,
    variants: [
...
export const WEATHER_TEMPLATES: CommentaryTemplate[] = [
  {
    tags: ['windy'],
    priority: 5,
    variants: [
...
export const CLOCK_TEMPLATES: CommentaryTemplate[] = [
  {
    tags: ['clock_management', 'two_minute'],
    priority: 16,
    variants: [
